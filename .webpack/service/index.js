...
/*!******************************************!*\
  ...
  \******************************************/
/*! exports provided: default */function(t,e,n){"use strict";n.r(e);var r=n(/*! ../utils/query.utils */"./utils/query.utils.js");e.default={create:async(t,e,{artists:n,users:r})=>{const a={};if(a.error)throw new Error(a.msg);const s=await n.create(e.artist).then(async t=>t.populate("user").populate("musical_styles").populate("songs").execPopulate()).catch(t=>{throw new Error(t)});return await r.findOneAndUpdate({_id:s.user._id},{artist:s._id},{new:!0}),s},findOne:(t,e,{artists:n})=>{const a=Object(r.sliceArgs)(e);return n.findOne(a.query.artist).populate("user").populate("approved_events").populate("subscribed_events").populate("recused_events").populate("musical_genres").populate("category").then(t=>t).catch(t=>{throw new Error(t)})},findAll:(t,e,{artists:n})=>{const a=Object(r.sliceArgs)(e);return n.find(a.query.artist).populate("user").populate("approved_events").populate("subscribed_events").populate("recused_events").populate("musical_genres").populate("category").then(t=>t).catch(t=>{throw new Error(t)})},update:(t,e,{artists:n})=>{const r={};if(r.error)throw new Error(r.msg);return n.findOneAndUpdate({_id:e.artist_id},e.artist,{new:!0}).populate("songs").populate("musical_styles").then(t=>t).catch(t=>{throw new Error(t)})}}},"./controllers/categoryOption.controller.js":
/*!**************************************************!*\
